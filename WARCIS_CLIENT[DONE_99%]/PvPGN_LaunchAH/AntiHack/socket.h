...
public:
	...
	virtual void PutBytes( const std::string &  bytes );
...
public:
	...
	virtual void Connect( const std::string & localaddress, const std::string & address, uint16_t port );
...
public:
	...
	virtual bool Listen( const std::string &  address, uint16_t port );
...
public:
	...
	virtual bool SendTo( const std::string &  address, uint16_t port, BYTEARRAY message );
	virtual bool Broadcast( uint16_t port, BYTEARRAY message );
	virtual void SetBroadcastTarget( const std::string &  subnet );
...
public:
	...
	virtual bool Bind( const std::string &  address, uint16_t port );
