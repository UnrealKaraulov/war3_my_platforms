...
namespace Storm {
	...
	extern PROTOTYPE_FileArchiveOpen FileOpenArchive_ptr;

	typedef BOOL (__stdcall *PROTOTYPE_Archive_OpenFile)( const char* a1, int * a2, size_t * a3, BOOL flag, int unk );
	extern PROTOTYPE_Archive_OpenFile Archive_OpenFile;
