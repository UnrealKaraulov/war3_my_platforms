...
class StormLib
{
    ...
    public static extern bool SFileAddListFile(IntPtr hMpq, string szListFile);
    /// <summary>
    ...
    public static extern bool SFileCloseArchive(IntPtr phMpq);
    /// <summary>
    ...
    public static extern bool SFileSetCompactCallback(IntPtr hMpq, SFILE_COMPACT_CALLBACK pfnCompactCB, IntPtr pvUserData);
    ...
    public static extern bool SFileOpenPatchArchive(IntPtr hMpq, string szMpqName, string szPatchPathPrefix, uint dwFlags);
    /// <summary>
    ...
    public static extern bool SFileOpenFileEx(IntPtr hMpq, string szFileName, uint dwSearchScope, ref uint phFile);
    /// <summary>
    ...
    public static extern uint SFileGetFileSize(IntPtr hMpq, ref uint pdwFileSizeHigh);
    /// <summary>
    ...
    public static extern uint SFileSetFilePointer(IntPtr hMpq, int lFilePos, ref int plFilePosHigh, uint dwMoveMethod);
    /// <summary>
    ...
    public static extern bool SFileReadFile(IntPtr hMpq, IntPtr lpBuffer, uint dwToRead, ref uint pdwRead, [MarshalAs(UnmanagedType.LPStruct)] IntPtr lpOverlapped);
    /// <summary>
    ...
    public static extern bool SFileGetFileName(IntPtr hMpq, ref string szFileName);
    /// <summary>
    ...
    public static extern uint SFileVerifyFile(IntPtr hMpq, string szFileName, uint dwFlags);
    /// <summary>
    ...
    public static extern bool SFileExtractFile(IntPtr hMpq, string szToExtract, string szExtracted, uint dwSearchScope);
    ...
    public static extern uint SFileFindFirstFile(IntPtr hMpq, string szMask, [MarshalAs(UnmanagedType.LPStruct)] SFILE_FIND_DATA lpFindFileData, string szListFile);
    /// <summary>
    ...
    public static extern uint SListFileFindFirstFile(IntPtr hMpq, string szListFile, string szMask, [MarshalAs(UnmanagedType.LPStruct)] SFILE_FIND_DATA lpFindFileData);
    /// <summary>
    ...
    public static extern bool SListFileFindClose(IntPtr hMpq, string szFileName, ref uint plcLocales, ref uint pdwMaxLocales, uint dwSearchScope);
    ...
    public static extern bool SFileCreateFile(IntPtr hMpq, string szArchivedName, ulong FileTime, uint dwFileSize, uint lcLocale, uint dwFlags, ref uint phFile);
    /// <summary>
    ...
    public static extern bool SFileWriteFile(IntPtr hMpq, IntPtr pvData, uint dwSize, uint dwCompression);
    /// <summary>
    ...
    public static extern bool SFileAddFile(IntPtr hMpq, string szfileName, string szArchivedName, uint dwFlags);
    /// <summary>
    ...
    public static extern bool SFileAddWave(IntPtr hMpq, string szfileName, string szArchivedName, uint dwFlags, uint dwQuality);
    /// <summary>
    ...
    public static extern bool SFileRemoveFile(IntPtr hMpq, string szFileName, uint dwSearchScope);
    /// <summary>
    ...
    public static extern bool SFileRenameFile(IntPtr hMpq, string szOldFileName, string szNewFileName);
    /// <summary>
    ...
    public static extern bool SFileSetAddFileCallback(IntPtr hMpq, SFILE_ADDFILE_CALLBACK pfnAddFileCB, IntPtr pvUserData);
