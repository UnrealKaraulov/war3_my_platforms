...
namespace NWar3Frame
{
	...
	extern pWc3ControlClickButton Wc3ControlClickButton_ptr;
	extern pWc3ControlClickButton Wc3ControlClickButton_org;
...
#pragma pack(pop)
#endif // _MSC_VER
	extern int( __thiscall * CFrameSetFocus )( int FrameAddr, int flag );
	typedef int( __fastcall * pGetFrameItemAddress )( const char * name, int id );
	extern pGetFrameItemAddress GetFrameItemAddress;
	extern int(__thiscall* Wc3SimulateClickEventListBox)(int listboxaddr, int specialgameaddr);
