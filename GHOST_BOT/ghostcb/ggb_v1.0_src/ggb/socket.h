...
public:
	CSocket( );
	CSocket( SOCKET nSocket, struct sockaddr_in nSIN ,bool suppress_error);
	~CSocket( );
	...
	virtual void Reset( );
	void SetSuppressError( bool value ) { m_SuppressError = value; }
};
...
public:
	CTCPSocket( );
	CTCPSocket( SOCKET nSocket, struct sockaddr_in nSIN ,bool suppress_error);
	virtual ~CTCPSocket( );
