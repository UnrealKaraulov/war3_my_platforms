...
namespace nsFTP
{
   ...
   public:
	  ...
	  int CrcHash(const tstring& strPath, long& hash) const;
...
/** \fn static const CTransferMode nsFTP::CTransferMode::Compressed()
   ...
   sent in a byte std::string; compressed data, consisting of
...
<PRE>
   ...
   To compress a std::string of n replications of the data byte d, the
...
<PRE>
   ...
   A std::string of n filler bytes can be compressed into a single
...
<PRE>
   ...
   succeeding std::string of bytes.
