...
private:
	...
	std::string m_LANRootAdmin;							// the LAN root admin
...
public:
	...
	std::string GetLANRootAdmin( )			{ return m_LANRootAdmin; }
	...
	std::vector<std::pair<std::string, int> > GetFriends( );
	std::vector<std::pair<std::string, int> > GetClan( );
	std::vector<std::pair<std::string, int> > GetBans( );
	std::vector<std::pair<std::string, int> > GetAdmins( );
	std::string GetReplyTarget( )			{ return m_ReplyTarget; }
	...
	void QueueEnterChat( );
	void QueueChatCommand( std::string chatCommand, bool hidden = false );
	void QueueChatCommand( std::string chatCommand, std::string user, bool whisper, bool whisperresponses );
	...
	bool IsLANRootAdmin( std::string name );
	...
	void HiddenGhostCommand( std::string Message );
};
