...
**
** The "version" of SQLite is a std::string of the form "X.Y.Z".
...
** in the sqlite3_version[] std::string constant.  The function is provided
** for use in DLLs since DLL users usually do not have direct access to std::string
...
** the error message.
**
** If the SQL statement in the 2nd parameter is NULL or an empty std::string
** or a std::string containing only whitespace and comments, then no SQL
...
** std::string of its 2nd parameter.  It returns a result table to the
...
** the result, [sqlite3_free()] is called on the input std::string. {END}
**
** Requirements:
...
** <dd>The maximum size of any std::string or BLOB or table row.<dd>
**
...
** std::string after SQLite has finished with it. If the fifth argument is
...
** The returned std::string is always UTF-8 encoded. {END}
**
...
** of the std::string.  For clarity: the value returned is the number of
...
** indicating that a std::string or BLOB is to long to represent.
**
...
**
** The name of the new collation sequence is specified as a UTF-8 std::string
** for sqlite3_create_collation() and sqlite3_create_collation_v2()
** and a UTF-16 std::string for sqlite3_create_collation16(). In all cases
...
** return negative, zero or positive if the first std::string is less than,
** equal to, or greater than the second std::string. i.e. (STRING1 - STRING2).
**
