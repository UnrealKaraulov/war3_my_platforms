...
/// returns the std::string which is used for display
...
/// return the std::string which is used for storage (e.g. in an XML- or INI-file)
...
CCommand::CCmd2Info::CCmd2Info()
{
   ...
   Insert(cmdXCRC,  _T("XCRC"),  _T("XCRC <SP> <pathname> <CRLF>"),                                       1, 0, RFC959,   NonDatachannel);
