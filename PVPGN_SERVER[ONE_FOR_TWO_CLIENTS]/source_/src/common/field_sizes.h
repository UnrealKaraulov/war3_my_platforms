...
const unsigned MAX_PACKET_SIZE = /*3072*/ 32767;
...
const unsigned MAX_USERPASS_LEN = 45; /* max password length as allowed by clients */
...
const int MAX_GAMEPASS_LEN = 32;
const int MAX_GAMEINFO_LEN = 128;
