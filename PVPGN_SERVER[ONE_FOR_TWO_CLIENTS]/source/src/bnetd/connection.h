...
namespace pvpgn
{
	...
	namespace bnetd
	{
		...
		struct AutoPlayPlayerQueueInfo
		{
			std::string MapCode;
			std::string Players;
			int rank;
		...
		extern std::vector<AutoPlayPlayerQueue> AutoPlayPlayerList;
		extern std::vector<AutoPlayPlayerQueueInfo> AutoPlayPlayerInfoList;
...
#ifdef CONNECTION_INTERNAL_ACCESS
		{
			...
			struct {
				...
				std::time_t			lastahtime;
				std::time_t			lastahtime2;
				std::time_t			lastahtime3;
				std::time_t			lastahtime4;
				std::time_t			lastbadgametime;
				unsigned int		hardwareid[ 4 ];
				unsigned int		LobbyNicknameColor;
				unsigned int		ChatNicknameColor;
				unsigned int		ChatTextColor;
				t_account *			followaccount;
				struct connection *		botconnection;
				t_game *			hostedgame;
				int			bot_locate;
				bool				IamBOT;
				bool				FoundWhiteMep;
...
#define conn_get_username(C) conn_get_username_real(C,__FILE__,__LINE__)
		...
		extern int conn_send_ah_gamestate( t_connection * c, const char * realusername, const char * newusername, const char * statsstring1
			, const char * statsstring2, const char * statsstring3, unsigned int var1 = 0, unsigned int var2 = 0, unsigned int var3 = 0, unsigned int var4 = 0 );
		...
		extern void RemoveHostedGameFromConnections( t_game * game, bool showmsg = true );
		...
		extern bool conn_ah_timeout( t_connection * c, int * reason = NULL );
		extern int conn_send_ah_gamemessagebox( t_connection * c, int messagetype, const char * message, int sleeptime = 500 );
