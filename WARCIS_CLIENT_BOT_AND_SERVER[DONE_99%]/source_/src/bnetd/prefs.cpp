...
//here
		...
		static t_conf_entry conf_table[] =
		{
			...
			//here
			{ "whitelistfile", conf_set_whitelistfile, conf_get_whitelistfile, conf_setdef_whitelistfile },
			//{ "userwhitelist", conf_set_whitelistfile, conf_get_whitelistfile, conf_setdef_whitelistfile },
			{ "crcwhitelistfile", conf_set_crcwhitelistfile, conf_get_crcwhitelistfile, conf_setdef_crcwhitelistfile },
			{ "blacklistfile", conf_set_blacklistfile, conf_get_blacklistfile, conf_setdef_blacklistfile },
		...
		{
			return 5/*prefs_runtime_config.latency*/;
		}
