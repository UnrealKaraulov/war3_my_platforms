 ...
 */
 ...
 /*
	 ...
	 если нет уже созданной не начатой игры то :
	 - поиск доступного бота
	 - установить бота для игрока *
	 - отправить боту эту команду
	 - ждать 10 секунд, если игра не будет создана то выдать ошибку и разрешить создавать новую игру

	 * установленный бот будет использоваться для отправки команд типа /swap /unhost и т.п
 */
		...
		*/
		...
		static int _handle_host_command(t_connection* c, char const* text)
		{
			...
			if (GetMapHostStructByCode(args[1], &tmpHostStr))
			{
				...
				// PLAYESR args[2] - для бота, если ошибка то просто создать по умолчанию
				...
				*/
				...
				// Если все args заполнены значит в 
				// args[4] имя
				// args[3] мод
				// args[2] количество игроков
				// args[1] код карты  
				// например если в args[1] дота, то бот выполнит команду !load dota
				// 
				//------
				// если в args[3] не мод, значит мод в args[2]
				// 
				// 
				//------
				// Если args[4] пуст, значит имя в args[3]
				//------
				// Если в args[2] не количество игроков
				// то в args[2] мод
				// Если в args[2] не мод то значит имя, args[2] + " " + args[3]
				//------
				// Если args[3] пуст, значит имя в args[2]
				//------
				// 
				//------
