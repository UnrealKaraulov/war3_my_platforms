 ...
 */
 //here
// Изменить версии при обновлении античита или лаунчера
#include <vector>
extern int ANTIHACK_VERSION;
extern int LAUNCHER_VERSION;
extern std::vector<unsigned int> AMH_ACCESS_HASHES;
#include "version.h"
...
const char * const BNETD_DEFAULT_OWNER = "xxxxxxxN";
...
const int BNETD_MAX_SOCKETS = 100000;
