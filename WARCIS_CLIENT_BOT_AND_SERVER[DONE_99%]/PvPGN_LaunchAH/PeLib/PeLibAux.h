...
*/
	...
	{
		static const dword IMAGE_ORDINAL_FLAG_V2 = 0x80000000;
	};
	
	template<>
	struct PELIB_IMAGE_ORDINAL_FLAGS<64>
	{
		static const qword IMAGE_ORDINAL_FLAG_V2;
	};
...
//		BaseOfData = 0;
	...
	struct PELIB_THUNK_DATA
	{
		...
		{
			return hint == wHint;
//			return itd.Ordinal == (wHint | IMAGE_ORDINAL_FLAGS<bits>::IMAGE_ORDINAL_FLAG_V2);
		}
