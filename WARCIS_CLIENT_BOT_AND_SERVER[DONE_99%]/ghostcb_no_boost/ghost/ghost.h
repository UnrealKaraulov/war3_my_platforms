...
public:
	...
	std::string m_Version;						// GHost++ version string
	...
	std::string m_ApprovedCountries;				// custom value: approved countries 
	// @disturbed_oc
	...
	std::string m_LANRootAdmin;					// custom value: the names of players if recognized from LAN will be root admins or admins
	...
	void EventBNETBROADCAST( CBNET *bnet, std::string user, std::string message );
	void EventBNETCHANNEL( CBNET *bnet, std::string user, std::string message );
	void EventBNETWHISPERSENT( CBNET *bnet, std::string user, std::string message );
	void EventBNETCHANNELFULL( CBNET *bnet, std::string user, std::string message );
	void EventBNETCHANNELDOESNOTEXIST( CBNET *bnet, std::string user, std::string message );
	void EventBNETCHANNELRESTRICTED( CBNET *bnet, std::string user, std::string message );
	void EventBNETError( CBNET *bnet, std::string user, std::string message );
	void EventBNETEmote( CBNET *bnet, std::string user, std::string message );
	void EventGameDeleted( CBaseGame *game );
	void EventBNETInfo( CBNET *bnet, std::string user, std::string message );
	...
	void CreateGame( CMap *map, unsigned char gameState, bool saveGame, std::string gameName,
		std::string ownerName, std::string creatorName, std::string creatorServer, bool whisper, std::string statstype );
};
