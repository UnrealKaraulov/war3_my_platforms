...
std::string CLanguage::UserUseMaphackWithCode( std::string code, std::string user )
{
	std::string Out = m_CFG->GetString( "lang_0215", "lang_0215" );
	UTIL_Replace( Out, "$CODE$", code );
