...
vector<std::string> CGHostDB :: AdminList( std::string server )
{
...
vector<CDBBan *> CGHostDB :: BanList( std::string server )
{
...
bool CGHostDB :: W3MMDVarAdd( uint32_t gameid, map<VarP,std::string> var_strings )
{
	return false;
}
...
CCallableGameAdd *CGHostDB :: ThreadedGameAdd( std::string server, std::string map, std::string gamename, std::string ownername, uint32_t duration, uint32_t gamestate, std::string creatorname, std::string creatorserver, std::string statstype )
{
	return NULL;
}
...
CCallableDotAGameAdd *CGHostDB :: ThreadedDotAGameAdd( uint32_t gameid, uint32_t winner, uint32_t min, uint32_t sec, uint32_t firstblood, std::string statstype )
{
	return NULL;
}
...
CCallableW3MMDVarAdd *CGHostDB :: ThreadedW3MMDVarAdd( uint32_t gameid, map<VarP,std::string> var_strings )
{
	return NULL;
}
...
CDBBan :: CDBBan( std::string nServer, std::string nName, std::string nIP, std::string nDate, std::string nGameName, std::string nAdmin, std::string nReason )
{
	m_Server = nServer;
	m_Name = nName;
	m_IP = nIP;
...
CDBGame :: CDBGame( uint32_t nID, std::string nServer, std::string nMap, std::string nDateTime, std::string nGameName, std::string nOwnerName, uint32_t nDuration )
{
	m_ID = nID;
	m_Server = nServer;
	m_Map = nMap;
...
CDBDotAGame :: CDBDotAGame( uint32_t nID, uint32_t nGameID, uint32_t nWinner, uint32_t nMin, uint32_t nSec , uint32_t firstblood, std::string statstype )
{
	m_ID = nID;
	m_GameID = nGameID;
	m_Winner = nWinner;
