	...
	namespace bnetd
	{
		...
		typedef enum
		{
			...
			*/
			...
			message_type_null,
			message_type_talk_green,
			message_type_talk_blue,
			message_type_talk_yellow,
			message_type_talk_custom,
		} t_message_type;

		typedef enum {
			message_class_normal,
			message_class_charjoin	/* use char*account (if account isn't d2 char is "") */
		} t_message_class;
